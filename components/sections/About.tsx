...
const teamMembers = [
    {
        name: "Rohit Parihar ⭐️",
        role: "Founder and Lead Architect",
        image: "/assets/images/rohitparihar.jpeg",
        description: "Backend and Frontend Systems Architect with 6+ years of experience building high-performance, scalable systems. Led the architecture of 40+ production applications, turning complex ideas into reliable, real-world solutions."
    },
    {
            ...
            <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 mb-12 sm:mb-20">
                    {stats.map((stat, index) => (
                        ...
                        >
                            <div
                                className="w-16 h-16 bg-green-soft/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-green-soft/20 transition-colors">
                        ...
                        {teamMembers.map((member, index) => (
                            ...
                            >
                                <CardContainer className="inter-var">
                                    <CardBody
                                        className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-green-soft/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-[500px] rounded-xl p-6 border flex flex-col">
                                        ...
                                        <CardItem translateZ="50" className="relative z-10 flex flex-col h-full">
                                            <div
                                                className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 border-4 border-green-soft/20 flex-shrink-0">
                                                <img
                                                    src={member.image}
                                                    alt={member.name}
                ...
                >
                    <div
                        className="bg-gradient-to-r from-green-soft/10 to-transparent rounded-2xl p-8 border border-green-soft/20">
